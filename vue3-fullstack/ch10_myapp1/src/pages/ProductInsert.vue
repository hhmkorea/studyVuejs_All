...
const submitForm = async () => {
  ...
  if (product.value.img1)
    formData.append("img1", product.value.img1);
  if (product.value.img2)
    formData.append("img2", product.value.img2);
  if (product.value.img3)
    formData.append("img3", product.value.img3);
